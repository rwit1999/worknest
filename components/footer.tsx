...
export const Footer = () => {
  return (
    <div className="h-72 p-4 items-start flex-col mt-14">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
        ...
        <div className="flex-col items-start justify-between gap-y-4 ml-4">
          {menuOne.map((item) => (
      ...
      <Separator />
      <div className="justify-center p-4 text-sm text-muted-foreground">
